...
public class RegexUtils {
    ...
    public static final String REGEX_MOBILE = "^((13[0-9])|(14[0-9])|(15[0-9])|(17[0-9])|(18[0-9]))[0-9]{8}$";
    ...
    public static void main(String[] args) {
        String username = "17605312834";
        System.out.println(RegexUtils.isMobile(username));
    ...
    public static boolean checkDate(String time) {
        boolean re = false;
        if (Pattern.matches(DATE_CHECK, time)) {
            re = true;
        } else if (Pattern.matches(TIME_CHECK, time)) {
            re = true;
        } else if (Pattern.matches(YYYYMMHHDDMI, time)){
            re = true;
        }
